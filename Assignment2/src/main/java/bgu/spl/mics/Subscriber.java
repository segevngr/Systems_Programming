...
public abstract class Subscriber extends RunnableSubPub {
    ...
    private ConcurrentHashMap <Class<? extends Message>, Callback> callbackMap; //Msg Type | Callback
    ...
    public final void run() {
        try {
            ...
            while(!terminated) {    // Get new messages from Q as long as not terminated
    ...
    public final void setSerialNumber(int m)
    {
        this.serialNumber = m;
    }
