...
public class NonBlockingConnectionHandler<T> implements ConnectionHandler<T> {
    ...
    public NonBlockingConnectionHandler(MessageEncoderDecoder reader, StompMessagingProtocol protocol, SocketChannel chan, Reactor reactor, int connectionId) {
        this.chan = chan;
        this.encdec = reader;
    ...
    public void startMessagingProtocol() {
